...
namespace bridge.api.bclogia.cz
{
    ...
    public partial class Bridge
    {
        ...
        public System.Threading.Tasks.Task<BCFirmyModel> FirmyAsync(int id)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<BCFirmyModel> FirmyAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<BCFirmyModel>(response_, headers_).ConfigureAwait(false);
        ...
        /// <summary>Předpis</summary>
        /// <param name="spolid">Společnost</param>
        /// <param name="id">ID předpisu</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<BCPredpis2DetailModel> PredpisAsync(int? spolid, int? id)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<BCPredpis2DetailModel> PredpisAsync(int? spolid, int? id, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<BCPredpis2DetailModel>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>Vyhledávání předpisů</summary>
        /// <param name="spolid">Společnost</param>
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<BCPredpis2ListModelBCPaging> SearchAsync(int? spolid, double? predCisloFrom, double? predCisloTo, System.DateTimeOffset? predDatumUZPFrom, System.DateTimeOffset? predDatumUZPTo, int? doklRadaID, System.DateTimeOffset? since, int? start, int? limit)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<BCPredpis2ListModelBCPaging> SearchAsync(int? spolid, double? predCisloFrom, double? predCisloTo, System.DateTimeOffset? predDatumUZPFrom, System.DateTimeOffset? predDatumUZPTo, int? doklRadaID, System.DateTimeOffset? since, int? start, int? limit, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<BCPredpis2ListModelBCPaging>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class BCFirmyModel 
    {
        ...
        /// <summary>Pokračování názvu</summary>
    ...
    public partial class BCPredpis2DenikModel 
    {
        ...
        /// <summary>Druh DPH: 0 - Bez DPH, 1 - Snížená sazba, 2 - Základní sazba, 3 - Třetí sazba</summary>
        ...
        /// <summary>Řádek výkazu DPH</summary>
        ...
        /// <summary>Ostatní párování</summary>
        ...
        /// <summary>Částka v zahraniční měně</summary>
        ...
        /// <summary>Prostředek/akce</summary>
        ...
        /// <summary>Číslo daňového dokladu text</summary>
        ...
        /// <summary>Členění pro souhrnné hlášení: 1 - zboží, 2 - služba</summary>
        ...
        /// <summary>Poznámka dlouhá</summary>
        ...
        /// <summary>Kód zboží (celní sazebník)</summary>
        ...
        /// <summary>Množství zboží</summary>
        ...
        /// <summary>Typ DPH (bez DPH, DPH 0%, osvobozeno, přenos DPH, přenos DPH samozdanění)</summary>
        ...
        /// <summary>Aktivita název</summary>
    ...
    /// <summary>Předpis detail</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.2.1.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class BCPredpis2DetailModel 
    {
        ...
        /// <summary>Rekapitulace částek</summary>
        ...
        /// <summary>Rekapitulace DPH</summary>
        ...
        /// <summary>Řádky předpisu</summary>
        ...
        /// <summary>Vazba deník - řádky předpisu</summary>
    ...
    /// <summary>Předpis rekapitulace DPH</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.2.1.0 (Newtonsoft.Json v11.0.0.0)")]
    ...
    public partial class BCPredpis2ListModel 
    {
        ...
        /// <summary>Číslo FA dodavatele</summary>
        ...
        /// <summary>Typ faktury: 1 - Faktura vydaná, 2 - Faktura přijatá</summary>
        ...
        /// <summary>Dokladová řada</summary>
    ...
    /// <summary>Data včetně stránkování</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.2.1.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class BCPredpis2ListModelBCPaging 
    {
        ...
        /// <summary>Celkový počet záznamů</summary>
    ...
    public partial class BCPredpis2Model 
    {
        ...
        /// <summary>Číslo objednávky</summary>
        ...
        /// <summary>Zahraniční FA - A/N</summary>
        [Newtonsoft.Json.JsonProperty("PredZahr", Required = Newtonsoft.Json.Required.Always)]
        public bool PredZahr { get; set; }
    
        /// <summary>Účetní stav faktury : 1 - Pořízený, 2 - Odsouhlasený, 3 - Nezaúčtovaný, 4 - Zaúčtovaný</summary>
        ...
        /// <summary>Datum vystavení</summary>
        ...
        /// <summary>Datum splatnosti</summary>
        ...
        /// <summary>Datum evidence</summary>
        ...
        /// <summary>Konstantní symbol</summary>
        ...
        /// <summary>Specifický symbol</summary>
        ...
        /// <summary>Zahraniční měna</summary>
        ...
        /// <summary>Účtoval - osobní číslo</summary>
        ...
        /// <summary>Datum operace předpisu</summary>
        ...
        /// <summary>Datum DPH předpisu</summary>
        ...
        /// <summary>Text daňové rekapitulace</summary>
        ...
        /// <summary>Pokračování názvu firmy</summary>
        ...
        /// <summary>Při tvorbě FA - použít hlavní smlouvu A/N</summary>
    ...
    /// <summary>Předpis vazba deník - řádek předpisu</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.2.1.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class BCPredpis2RadkyDenikModel 
    {
        ...
        /// <summary>ID řádku dokladu</summary>
        [Newtonsoft.Json.JsonProperty("ID", Required = Newtonsoft.Json.Required.Always)]
        public int ID { get; set; }
    
        /// <summary>ID dokladu</summary>
        [Newtonsoft.Json.JsonProperty("DenID", Required = Newtonsoft.Json.Required.Always)]
        public int DenID { get; set; }
    
        /// <summary>Množství</summary>
    ...
    public partial class BCPredpis2RadkyModel 
    {
        ...
        /// <summary>Pořadí řádku faktury</summary>
        [Newtonsoft.Json.JsonProperty("PredObsPoradi", Required = Newtonsoft.Json.Required.Always)]
        public int PredObsPoradi { get; set; }
    
        /// <summary>ID řádku</summary>
        [Newtonsoft.Json.JsonProperty("ID", Required = Newtonsoft.Json.Required.Always)]
        public int ID { get; set; }
    
        /// <summary>Typ řádku (B - běžný, H - text, C - zaplacená záloha, V - haléřové vyrovnání)</summary>
        ...
        /// <summary>Cena s DPH celkem</summary>
        ...
        /// <summary>Číslo zálohové faktury</summary>
        ...
        /// <summary>Číslo daňového dokladu k platbě</summary>
        ...
        /// <summary>Nákladové středisko</summary>
        ...
        /// <summary>druh DPH (0 - bez DPH, 1 - snížená sazba, 2 - základní sazba)</summary>
        [Newtonsoft.Json.JsonProperty("DrDph", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? DrDph { get; set; }
        ...
        /// <summary>Název aktivity</summary>
        [Newtonsoft.Json.JsonProperty("AktNazev", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.StringLength(50)]
        public string AktNazev { get; set; }
